...
public class EntityProcessorTest {
    ...
    void generatesRegistryForSimpleEntity() {
        ...
        assertThat(compilation)
                .generatedSourceFile("io.github.cyfko.jpa.metamodel.providers.PersistenceMetadataRegistryProviderImpl")
        ...
        assertThat(compilation)
                .generatedSourceFile("io.github.cyfko.jpa.metamodel.providers.PersistenceMetadataRegistryProviderImpl")
                .contentsAsUtf8String()
                .contains("fields.put(\"id\", new PersistenceMetadata(true, java.lang.Long.class, Optional.empty(), Optional.empty()))");

        // Vérifier que name est un champ scalar simple
        assertThat(compilation)
                .generatedSourceFile("io.github.cyfko.jpa.metamodel.providers.PersistenceMetadataRegistryProviderImpl")
                .contentsAsUtf8String()
                .contains("fields.put(\"name\", new PersistenceMetadata(false, java.lang.String.class, Optional.empty(), Optional.empty()))");
    ...
    void generatesRegistryForEntityWithMappedSuperclassAndEmbeddedId() {
        ...
        assertThat(compilation)
                .generatedSourceFile("io.github.cyfko.jpa.metamodel.providers.PersistenceMetadataRegistryProviderImpl")
                .contentsAsUtf8String()
                .contains("fields.put(\"key\", new PersistenceMetadata(true, com.example.EntityKey.class, Optional.empty(), Optional.empty()))");

        // label est un champ scalar
        assertThat(compilation)
                .generatedSourceFile("io.github.cyfko.jpa.metamodel.providers.PersistenceMetadataRegistryProviderImpl")
                .contentsAsUtf8String()
                .contains("fields.put(\"label\", new PersistenceMetadata(false, java.lang.String.class, Optional.empty(), Optional.empty()))");
    }
    ...
    void generatesRegistryForEntityWithIdClassAndMapsId() {
        ...
        assertThat(compilation)
                .generatedSourceFile("io.github.cyfko.jpa.metamodel.providers.PersistenceMetadataRegistryProviderImpl")
                .contentsAsUtf8String()
                .contains("fields.put(\"orderId\", new PersistenceMetadata(true, java.lang.Long.class, Optional.empty(), Optional.empty()))");

        // product est une relation avec @MapsId
        assertThat(compilation)
                .generatedSourceFile("io.github.cyfko.jpa.metamodel.providers.PersistenceMetadataRegistryProviderImpl")
                .contentsAsUtf8String()
                .contains("fields.put(\"product\", new PersistenceMetadata(false, com.example.Product.class, Optional.of(\"productId\"), Optional.empty()))");

        // order est une relation avec @MapsId
        assertThat(compilation)
                .generatedSourceFile("io.github.cyfko.jpa.metamodel.providers.PersistenceMetadataRegistryProviderImpl")
                .contentsAsUtf8String()
                .contains("fields.put(\"order\", new PersistenceMetadata(false, com.example.Order.class, Optional.of(\"orderId\"), Optional.empty()))");

        // quantity est un champ scalar
        assertThat(compilation)
                .generatedSourceFile("io.github.cyfko.jpa.metamodel.providers.PersistenceMetadataRegistryProviderImpl")
                .contentsAsUtf8String()
                .contains("fields.put(\"quantity\", new PersistenceMetadata(false, int.class, Optional.empty(), Optional.empty()))");
    }
    ...
    void generatesRegistryForEntityWithInheritance() {
        ...
        assertThat(compilation)
                .generatedSourceFile("io.github.cyfko.jpa.metamodel.providers.PersistenceMetadataRegistryProviderImpl")
                .contentsAsUtf8String()
                .contains("fields.put(\"loyaltyCode\", new PersistenceMetadata(false, java.lang.String.class, Optional.empty(), Optional.empty()))");
    }
    ...
    void generatesRegistryForCustomerOrderModel() {
        ...
        assertThat(compilation)
                .generatedSourceFile("io.github.cyfko.jpa.metamodel.providers.PersistenceMetadataRegistryProviderImpl")
                .contentsAsUtf8String()
                .contains("fields.put(\"customer\", new PersistenceMetadata(false, com.example.Customer.class, Optional.empty(), Optional.empty()))");
    ...
    void generatesRegistryForEcommerceModel() {
        ...
        assertThat(compilation)
                .generatedSourceFile("io.github.cyfko.jpa.metamodel.providers.PersistenceMetadataRegistryProviderImpl")
                .contentsAsUtf8String()
                .contains("fields.put(\"address\", new PersistenceMetadata(false, com.example.Address.class, Optional.empty(), Optional.empty()))");
        ...
        assertThat(compilation)
                .generatedSourceFile("io.github.cyfko.jpa.metamodel.providers.PersistenceMetadataRegistryProviderImpl")
                .contentsAsUtf8String()
                .contains("fields.put(\"product\", new PersistenceMetadata(false, com.example.Product.class, Optional.empty(), Optional.empty()))");
    }
    ...
    void generatedRegistryCanBeLoadedViaReflection() throws Exception {
        ...
        assertThat(compilation)
                .generatedSourceFile("io.github.cyfko.jpa.metamodel.providers.PersistenceMetadataRegistryProviderImpl")
                .contentsAsUtf8String()
                .contains("public static final Map<Class<?>, Map<String, PersistenceMetadata>> ENTITY_METADATA_REGISTRY;");

        assertThat(compilation)
                .generatedSourceFile("io.github.cyfko.jpa.metamodel.providers.PersistenceMetadataRegistryProviderImpl")
                .contentsAsUtf8String()
                .contains("public static final Map<Class<?>, Map<String, PersistenceMetadata>> EMBEDDABLE_METADATA_REGISTRY;");
