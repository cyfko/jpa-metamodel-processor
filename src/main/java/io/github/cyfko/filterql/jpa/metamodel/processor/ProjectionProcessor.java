...
import static io.github.cyfko.filterql.jpa.metamodel.processor.ProcessorUtils.BASIC_JPA_TYPES;
...
public class ProjectionProcessor {
    ...
    public void generateProviderImpl() {
        ...
        try {
            JavaFileObject file = processingEnv.getFiler()
                    .createSourceFile("io.github.cyfko.filterql.jpa.metamodel.providers.ProjectionMetadataRegistryProviderImpl");
    ...
    private void writeProjectionRegistry(Writer writer) throws IOException {
        writer.write("package io.github.cyfko.filterql.jpa.metamodel.providers;\n\n");
        writer.write("import io.github.cyfko.filterql.jpa.metamodel.model.projection.*;\n");
        writer.write("import io.github.cyfko.filterql.jpa.metamodel.model.CollectionKind;\n");
        writer.write("import io.github.cyfko.filterql.jpa.metamodel.model.CollectionType;\n");
